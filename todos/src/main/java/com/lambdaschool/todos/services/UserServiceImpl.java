...
public class UserServiceImpl implements UserService {
    ...
    public User save(User user) {
        ...
        /** added the todos to the save overide method **/
        newUser.getTodos().clear();

        // foreach to do get and add description
    ...
    @Override
    public List<UserNameCountTodos> getUserNameCountTodos() { return userrepos.getUserNameCountTodos(); }
}
